...
public class IzmeniVozilo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int voziloID = Integer.parseInt(request.getParameter("voziloID"));
		...
		vozilo = new Vozilo(voziloID, datum, vreme, marka, tip, godiste, imeVlasnika, telefon, adresa);
		
		crudVoziloDao.izmeniVozilo(vozilo);
